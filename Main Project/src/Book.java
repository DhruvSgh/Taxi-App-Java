...
public class Book extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText(" Price per km (in Rs.)");
...
var.bid=jTextField1.getText();
        ...
        int fee = Integer.parseInt(jTextField5.getText());
                try
        {
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/school1","root","dhruvsingh");
            Statement stmt = con.createStatement();
            String query = "INSERT INTO student values ("+rollno+",'"+name+"',"+cls+",'"+sec+"',"+fee+")";
